...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", background: "#000" }}>
      ...
      {/* Form container */}
      <div style={{ width: "100%", maxWidth: "340px", padding: "0 24px", position: "relative", zIndex: 10 }}>
        ...
        >
          <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
            <div className="iridescent-bg" style={{ width: "32px", height: "32px", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
